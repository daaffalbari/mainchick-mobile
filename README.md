...
| ------------------- | ----------------- | ------------------------------ |
| Zulfi Fadilah Azhar | Hardware Engineer | Universitas Komputer Indonesia |
| Daffa Albari        | Software Engineer | Universitas Komputer Indonesia |
| Rissopan Panji      | Data Scientist    | Universitas Komputer Indonesia |
| Asifa Lestari       | Product Designer  | Universitas Komputer Indonesia |
